...
# Updated data with dot separators for tasks
data = {
    "Competencies": [
...
# Save to Excel
df.to_excel("data_into_spreadsheet/competencies_and_tasks2.xlsx", index=False)

# Print the DataFrame to review the updated tasks with dots
print(df)
